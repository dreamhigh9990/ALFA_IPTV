    ...
    () => [
      ...
      // ----------------------------------------------------------------------
      {
        ...
        items: [
          ...
          { title: t('user'), path: paths.dashboard.user.list, icon: ICONS.user },
          {
            title: 'Credits',
            path: paths.dashboard.credit.list,
            icon: ICONS.order,
          },
          {
            title: 'Spents',
            path: paths.dashboard.spent.list,
            icon: ICONS.invoice,
          },
          { title: 'Wallet', path: paths.dashboard.wallet.list, icon: ICONS.product },
          // { title: t('invoice'), path: paths.dashboard.invoice.list, icon: ICONS.invoice },
          // {
          //   title: t('banking'),
